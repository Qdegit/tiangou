<template>
    <div id="con">
        <section>
            ...
            <article>
                <div class="swiper-container shopImg" ref="banner">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><img :src="detailImg.imageUrl"></div>
                        <div class="swiper-slide"><img :src="detailImg.imageUrl"></div>
                        <div class="swiper-slide"><img :src="detailImg.imageUrl"></div>
                    </div>
                    <!-- 如果需要分页器 -->
                ...
                <div class="shopDetail">
                    ...
                    <div class="shopDetail_con"><h6>{{detailList.title ? detailList.title:detailChil.productName}}</h6><p>{{detailList.promotion}}</p></div>
                    <div class="shopDetail_bot">{{detailList.provider ? detailList.provider : detailChil.storeName}}</div>
                </div>
	...
	export default {
        ...
        computed:{
            ...Vuex.mapState({
                ...
                detailChil : state => state.home.detailChil
            })
        },
        methods:{
            ...Vuex.mapActions({
