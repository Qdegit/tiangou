<template>
    <div>
        <form action="">
            <div class="main">
                ...
                <div class="p">
                    ...
                    <div>
                        <input type="text" placeholder="请输入6-16位密码" maxlength="16"/>
                    </div>
                </div>
            </div>          
        </form>
        <div class="foot">
            <button>登录</button>
            <p @click="goSign">免费注册</p>
            <p>忘记密码</p>
        </div>
        <div class="bottom">
            <span>登录即代表您同意</span>
            <a href="protectionProtocol.html">《天狗网隐私保护政策》</a>
        </div> 
    </div>
</template>
<script>
